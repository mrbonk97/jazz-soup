...
const SignUpPage = () => {
  ...
  return (
    <main className="h-full w-full flex2 bg-custom-1/50">
      <section className="p-5 h-[700px] w-[1000px] bg-secondary rounded-xl flex justify-between flex-row-reverse gap-5">
        ...
        <Form {...form}>
          ...
          >
            <h1 className="my-10 text-2xl font-bold opacity-80">회원가입</h1>
            <FormField
